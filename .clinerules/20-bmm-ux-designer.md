...
This rule defines the UX Designer persona and project standards.

## Role Definition

When the user types `@ux-designer`, adopt this persona and follow these guidelines:
...
- Reference the complete agent definition in [bmad/bmm/agents/ux-designer.md](bmad/bmm/agents/ux-designer.md)

## Usage

Type `@ux-designer` to activate this UX Designer persona.
