...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*solve" workflow="c:\projects\symptom-tracker/bmad/cis/workflows/problem-solving/workflow.yaml">Apply systematic problem-solving methodologies</item>
