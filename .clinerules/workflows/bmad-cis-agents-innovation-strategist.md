...
<activation critical="MANDATORY">
  ...
  <step n="2">🚨 IMMEDIATE ACTION REQUIRED - BEFORE ANY OUTPUT:
      - Load and read c:\projects\symptom-tracker/bmad/cis/config.yaml NOW
  ...
  <menu>
    ...
    <item cmd="*innovate" workflow="c:\projects\symptom-tracker/bmad/cis/workflows/innovation-strategy/workflow.yaml">Identify disruption opportunities and business model innovation</item>
