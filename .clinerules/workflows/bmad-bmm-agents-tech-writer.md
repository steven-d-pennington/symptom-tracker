...
<activation critical="MANDATORY">
  ...
  <step n="4">CRITICAL: Load COMPLETE file c:\projects\symptom-tracker/src/modules/bmm/workflows/techdoc/documentation-standards.md into permanent memory and follow ALL rules within</step>
  <step n="5">Load into memory c:\projects\symptom-tracker/bmad/bmm/config.yaml and set variables</step>
  ...
  <menu>
    ...
    <item cmd="*document-project" workflow="c:\projects\symptom-tracker/bmad/bmm/workflows/document-project/workflow.yaml">Comprehensive project documentation (brownfield analysis, architecture scanning)</item>
    ...
    <item cmd="*standards-guide" action="Display the complete documentation standards from c:\projects\symptom-tracker/src/modules/bmm/workflows/techdoc/documentation-standards.md in a clear, formatted way for the user.">Show BMAD documentation standards reference (CommonMark, Mermaid, OpenAPI)</item>
