...
import { ImmersiveBodyMapWrapper } from './ImmersiveBodyMapWrapper';
      ...
      <div className="flex flex-col gap-4 h-full">
        ...
        <div className="flex-1 min-h-0 relative">
          <svg
            ...
            className="w-full h-full border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800"
