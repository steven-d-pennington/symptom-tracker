/**
 * SymptomEmptyState Component (Story 3.5.1 - Task 5)
 *
 * Empty state component displayed when user has no custom symptoms.
 * Shows guidance to add custom symptoms in Settings.
 *
...
/**
 * SymptomEmptyState component for displaying message when no custom symptoms exist.
