/**
 * TriggerEmptyState Component (Story 3.5.1 - Task 5)
 *
 * Empty state component displayed when user has no custom triggers.
 * Shows guidance to add custom triggers in Settings.
 *
...
/**
 * TriggerEmptyState component for displaying message when no custom triggers exist.
  ...
  return (
    ...
    <section className="bg-gray-50 rounded-lg p-6 text-center border-2 border-dashed border-gray-300">
      ...
      <h3 className="text-lg font-semibold text-gray-900 mb-2">
        No custom triggers yet
      </h3>

      {/* AC3.5.1.5: Description with guidance */}
      <p className="text-gray-600 mb-4">
        You're using default triggers. Add your own in Settings to personalize tracking.
      </p>
