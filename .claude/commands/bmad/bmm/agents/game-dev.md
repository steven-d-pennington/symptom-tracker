...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*review-story" workflow="C:\projects\symptom-tracker/bmad/bmm/workflows/4-implementation/review-story/workflow.yaml">Review Story Implementation</item>
