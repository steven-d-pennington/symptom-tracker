...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*plan-project" workflow="C:\projects\symptom-tracker/bmad/bmm/workflows/2-plan/workflow.yaml">UX Workflows, Website Planning, and UI AI Prompt Generation</item>
