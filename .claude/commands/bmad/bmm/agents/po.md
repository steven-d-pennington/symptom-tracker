...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*assess-project-ready" validate-workflow="C:\projects\symptom-tracker/bmad/bmm/workflows/3-solutioning/workflow.yaml">Validate if we are ready to kick off development</item>
