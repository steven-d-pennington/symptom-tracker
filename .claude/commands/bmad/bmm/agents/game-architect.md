...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*solutioning" workflow="C:\projects\symptom-tracker/bmad/bmm/workflows/3-solutioning/workflow.yaml">Design Technical Game Solution</item>
    <item cmd="*tech-spec" workflow="C:\projects\symptom-tracker/bmad/bmm/workflows/3-solutioning/tech-spec/workflow.yaml">Create Technical Specification</item>
